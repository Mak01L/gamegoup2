...
const RoomsList: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#18122B] via-purple-800 to-purple-300 font-inter text-white p-6 flex flex-col items-center">
      ...
      <div className="w-full max-w-md flex flex-col gap-4">
        ...
        {rooms.map((room) => (
          <div
            key={room.id}
            className="bg-[#281e46]/70 rounded-2xl p-5 shadow-lg border border-purple-700 flex flex-col gap-1"
          >
